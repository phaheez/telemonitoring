<!-- Modal -->
<div id="change-password<?php echo $doctor_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" 
    aria-hidden="true">
                        ...
                        <div class="modal-footer">
                            ...
                            if (isset($_POST['btnChange'])) {
                                ...
                                if ($new !== $confirm) {
                                    ...
                                    mysql_query("UPDATE doctor SET password='$new' WHERE doctor_id='$doctorID'") or die(mysql_error());
                                    ?>
                                    <script>
